...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void navigateToGameScreen(GamePlayState gamePlayState, SettingsState settingsState, int levelIndex) {
      ...
      Widget levelContainer = Container(
        ...
        child: Center(
          child: GestureDetector(
            onTap: () {
              navigateToGameScreen(gamePlayState,settingsState,(i+1));
            },
            child: Container(
            ...
            return Container(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    SizedBox(height: gamePlayState.tileSize,),
                    Container(
                    ...
                    Wrap(
                      children: getLevelList(gamePlayState,settingsState)
                    )
                  ],
                ),
              ),
